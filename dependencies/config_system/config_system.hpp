...
namespace sdk {
	...
	public:
		...
		// 0 - normal, 1 - fast, 2 - very fast
		int double_tap_mode = 0;
		...
		int heavy_pistols_double_tap_mode = 0;
		...
		int sub_machine_guns_double_tap_mode = 0;
		...
		int auto_snipers_double_tap_mode = 0;
		...
		int shotguns_double_tap_mode = 0;
		...
		int machine_guns_double_tap_mode = 0;
		...
		// Fake peek/fake head (same functionality, different name)
		bool fake_peek;
		int fake_peek_mode = 1; // 0 = "fake peek", 1 = "fake head"
		int fake_peek_type = 0; // 0 = normal (doesn't break LBY), 1 = break (breaks LBY)
		int fake_peek_key;
		int fake_peek_key_style = 2;
		
		// Custom desync
		bool custom_desync;
		int desync_mode = 0; // 0 = default, 1 = jitter, 2 = static, 3 = random
		float desync_amount = 60.f;
		float desync_inverter = 1.f;
		
		// Resolver modes
		int resolver_mode = 0; // 0 = default, 1 = advanced, 2 = custom
	...
	public:
		...
		int anti_aim_mode = 0; // 0 - classic, 1 - static random jitter, 2 - spiral, 3 - pulse
		int spiral_speed = 10; // deg per tick
		int pulse_range = 90; // degrees
		int pulse_speed = 30; // ticks per switch
